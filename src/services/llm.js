...
8. Terminology rules:
   - In English responses: use "full-time employees" and "contractors" — never mix in Ukrainian words.
   - In Ukrainian responses: write "full-time працівники" (NEVER "повні працівники", NEVER "повні співробітники") and "контрактори" (not "підрядники").
